# Terminal Tools Inventory

Complete catalog of terminal tools, organized by category.

**See also:** [TERMINAL-TOOLS.md](TERMINAL-TOOLS.md) for shell integration.
...
```bash
sysdiag               # full system info (custom script)
```
