...
}:
{
  ...
  services.tlp.settings = {
    ...
    CPU_SCALING_GOVERNOR_ON_SAV = lib.mkForce "schedutil";
    CPU_BOOST_ON_AC = 1;
    CPU_BOOST_ON_BAT = 1;
    CPU_BOOST_ON_SAV = 0;
    SATA_LINKPWR_ON_AC = lib.mkForce "max_performance";
    SATA_LINKPWR_ON_BAT = lib.mkForce "max_performance";
    SATA_LINKPWR_ON_SAV = lib.mkForce "med_power_with_dipm";
    USB_AUTOSUSPEND = lib.mkForce 0;
    # BCM4331 drops WiFi under any power saving -- keep it off in every mode.
