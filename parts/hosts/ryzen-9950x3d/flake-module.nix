...
{ inputs, ... }:
{
  flake.nixosConfigurations.ryzen-9950x3d = inputs.nixpkgs-unstable.lib.nixosSystem {
    specialArgs = {
      inherit inputs;
    ...
    modules = [
      ...
      (
        { config, ... }:
        {
          imports = [
            ...
            # Input
            inputs.self.modules.nixos.input-controllers
      ...
      inputs.home-manager.nixosModules.home-manager
      {
        ...
        home-manager.sharedModules = [
          ...
          inputs.coolercontrol-nix.homeManagerModules.default
          inputs.lmstudio-nix.homeManagerModules.default
          inputs.rocksmith-nix.homeManagerModules.default
          inputs.cod-clients-nix.homeManagerModules.default
