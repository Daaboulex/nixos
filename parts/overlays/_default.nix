...
let
  ...
  inputOverlays = [
    ...
    inputs.umu-proton-nix.overlays.default
    inputs.vkbasalt-overlay.overlays.default
    inputs.mesa-git-nix.overlays.default
    inputs.coolercontrol-nix.overlays.default
    inputs.openviking-nix.overlays.default
    inputs.lmstudio-nix.overlays.default
    inputs.free-claude-code-nix.overlays.default
    ...
    inputs.eden-nix.overlays.default
  ];
in
{
  ...
  flake.overlays.default = inputs.nixpkgs-unstable.lib.composeManyExtensions (
  ...
  flake.overlays.probe = inputs.nixpkgs-unstable.lib.composeManyExtensions inputOverlays;
}
