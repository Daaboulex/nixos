...
pkgs.writeShellApplication {
  ...
  text = ''
    ...
    for f in "''${files[@]}"; do
      ...
      # Factory wrappers declare their flake.modules export inside the
      # factory (lib/mkSimpleNixosModule.nix); the call is the declaration.
      if grep -q 'mkSimpleNixosModule' "$f"; then
        continue
      fi
