...
pkgs.writeShellApplication {
  ...
  text = ''
    # Leading (^|[^a-z]) boundary so "removed from" doesn't match "moved from".
    pat='(^|[^a-z])(moved from|renamed (from|to)|formerly|used to be|as requested|per the (audit|user|review|request)|this session|\(NEW\)|no longer (needed|used|required)|we now|TODO:|FIXME|XXX:| HACK )'
