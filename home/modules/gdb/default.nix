  ...
  config = lib.mkIf cfg.enable {
    ...
    + lib.optionalString hasTheme (
      ...
      ''
        ...
        set style address foreground ${a.blue-ansi}
        set style function foreground ${a.blue-alt-ansi}
        set style variable foreground ${a.orange-ansi}
        set style string foreground ${a.green-ansi}
        set style filename foreground ${a.green-ansi}
        set style highlight foreground ${a.red-ansi}
        set style metadata foreground ${a.purple-ansi}
        set style tui-border foreground ${a.blue-alt-ansi}
        set style tui-active-border foreground ${a.blue-ansi} bold
      ''
    )
