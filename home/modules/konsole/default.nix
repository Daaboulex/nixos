  ...
  config = lib.mkIf cfg.enable {
    ...
    programs.konsole = myLib.mergeSettings {
      ...
      // lib.optionalAttrs hasTheme {
        # Structured scheme, rendered by plasma-manager's ini generator. A
        # pre-rendered file (writeText) breaks its `builtins.isPath` branch:
        # a derivation is not a path literal, so it lands in the ini
        # generator, which cannot map over a derivation's attrset.
        customColorSchemes."BreezeDark-Custom" = {
          Background.Color = c.background-rgb;
          BackgroundIntense.Color = c.surface-rgb;
          Color0.Color = c.background-rgb;
          Color0Intense.Color = c.surface-rgb;
          Color1.Color = c.red-rgb;
          Color1Intense.Color = c.red-rgb;
          Color2.Color = c.green-rgb;
          Color2Intense.Color = c.green-rgb;
          Color3.Color = c.orange-rgb;
          Color3Intense.Color = c.orange-rgb;
          Color4.Color = c.blue-rgb;
          Color4Intense.Color = c.blue-rgb;
          Color5.Color = c.purple-rgb;
          Color5Intense.Color = c.purple-rgb;
          Color6.Color = c.blue-alt-rgb;
          Color6Intense.Color = c.blue-alt-rgb;
          Color7.Color = c.foreground-dim-rgb;
          Color7Intense.Color = c.foreground-rgb;
          Foreground.Color = c.foreground-rgb;
          ForegroundIntense.Color = c.foreground-rgb;
          General = {
